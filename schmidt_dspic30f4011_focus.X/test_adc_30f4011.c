...
int main(int argc, char** argv) 
{
    ...
    while(1)
    {
        ...
        tx_1_data[0] =  PORTDbits.RD0 +48;
        tx_1_data[1] =  ' ';
        tx_1_data[2] =  PORTDbits.RD1 +48;
        tx_1_data[3] =  ' ';
        tx_1_data[4] =  PORTDbits.RD2+48;
        tx_1_data[5] =  ' ';
        tx_1_data[6] =  '\n';
        tx_1_data[7] =  '\r';
...
void __attribute__((__interrupt__, __auto_psv__)) _T4Interrupt(void)
{
    ...
    focus.plim = limit_pos ;
    focus.nlim = limit_neg ;
   ...
   // while(!ADCON1bits.DONE);
    ...
    if(focus.move_command&(focus.ok_to_move_pos||focus.ok_to_move_neg))
    {
        ...
        {    
            ...
            {
                if(focus.stop_command || focus.move_command)
                {
                    break;
                }
...
void __attribute__((__interrupt__, __auto_psv__)) _T2Interrupt(void)
{
    ...
    if(timer_2_counter == 2)    //200 ms timer x 5 = 1000 ms
    {
        ...
        tx_1_data[22] =  ' ';
        tx_1_data[23] =  (adc_2_value)/1000%10+48;
        tx_1_data[24] =  (adc_2_value)/100%10+48;
        tx_1_data[25] =  (adc_2_value)/10%10+48;
        tx_1_data[26] =  (adc_2_value)%10+48;
        if(focus.soft_nlim<0)
            tx_1_data[27] =  '-';
        else 
            tx_1_data[27] =  '+';
        tx_1_data[28] =  adc_1_value/10000%10+48;//abs(focus.soft_nlim)/10000%10+48;
        tx_1_data[29] =  adc_1_value/1000%10+48;//abs(focus.soft_nlim)/1000%10+48;
        tx_1_data[30] =  adc_1_value/100%10+48;//abs(focus.soft_nlim)/100%10+48;
        tx_1_data[31] =  adc_1_value/10%10+48;//abs(focus.soft_nlim)/10%10+48;
        tx_1_data[32] =  adc_1_value%10+48;//abs(focus.soft_nlim)%10+48;
        tx_1_data[33] =  ' ';
         if(focus.soft_plim<0)
            tx_1_data[34] =  '-';
        else 
            tx_1_data[34] =  '+';
        tx_1_data[35] =  abs(focus.soft_plim)/10000%10+48;
        tx_1_data[36] =  abs(focus.soft_plim)/1000%10+48;
        tx_1_data[37] =  abs(focus.soft_plim)/100%10+48;
        tx_1_data[38] =  abs(focus.soft_plim)/10%10+48;
        tx_1_data[39] =  abs(focus.soft_plim)%10+48;
        tx_1_data[40] =  ' ';
        
        
        tx_1_data[41] =  focus.status3>>8;
        tx_1_data[42] =  focus.status3;
        tx_1_data[43] =  focus.status3>>8;
        tx_1_data[44] =  focus.status3;
        tx_1_data[45] =  focus.status3>>8;
        tx_1_data[46] =  focus.status3;
        tx_1_data[47] =  ' ';
        tx_1_data[48] =  '\n';
        tx_1_data[49] =  '\r';
